...
macro(cyitk_configure_module moduleName pyxSrcs)
  ...
  foreach(CPP_FILE ${CYITK_IMAGE_SRCS})
    ...
    target_link_libraries(${CYITK_IMAGE_CLASSES_TARGET_NAME} ${ITK_LIBRARIES} ${PYTHON_LIBRARY})
  ...
  foreach(CPP_FILE ${CYITK_SRCS})
    ...
    target_link_libraries(${MODULE_NAME} ${ITK_LIBRARIES} ${PYTHON_LIBRARY} ${CYITK_WRAPPED_LIBRARIES})
